<?php
			class SaladesController extends BaseController
								{
									private $SaladesModel;									
									public function Salades()
																						{
																							$this->SaladesModel=new SaladesModel("modena","homepage");	//ACTIVATION DATABASE MODENA
																						...
																						//	 echo	$tab["id"]."</br>";
																						  ...
																						  /*   foreach( $this->HomeModel->message() as $key => $value)
																							...
																							$this->view("Salades","","","SALADES","$contentView ");	
																						}								
								}
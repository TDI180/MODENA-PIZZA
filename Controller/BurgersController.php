<?php
			class BurgersController extends BaseController
								{
									private $BurgersModel;									
									public function Burgers()
																						{
																							$this->BurgersModel=new BurgersModel("modena","homepage");	//ACTIVATION DATABASE MODENA
																						...
																						//	 echo	$tab["id"]."</br>";
																						  ...
																						  /*   foreach( $this->HomeModel->message() as $key => $value)
																							...
																							$this->view("burgers","","","BURGERS","$contentView ");	
																						}								
								}